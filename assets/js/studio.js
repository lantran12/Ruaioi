...
function loadAdminStoryList() {
    ...
    onChildAdded(storiesRef, (snapshot) => {
        ...
        item.id = `story-${id}`; 
        // Thay display: flex thành flex-direction: column
        item.style = "padding: 15px; border-bottom: 1px solid #eee; display: flex; flex-direction: column; background: #fff; margin-bottom: 10px; border-radius: 12px; gap: 10px;";
        ...
        item.innerHTML = `
            ...
            <div style="display: flex; gap: 8px; flex-wrap: wrap;">
                <button onclick="editStory('${id}')" style="background: #fff3bf; border: none; padding: 6px 12px; border-radius: 20px; font-size: 12px; cursor: pointer;">Sửa</button>
                <button onclick="deleteStory('${id}')" style="background: #ffdede; color: #d90429; border: none; padding: 6px 12px; border-radius: 20px; font-size: 12px; cursor: pointer;">Xóa</button>
                <button onclick="openPostModal('${id}', '${story.title}')" style="background: #e0f2f1; color: #00796b; border: none; padding: 6px 12px; border-radius: 20px; font-size: 12px; cursor: pointer;">Đăng chương</button>
            </div>
        `;
